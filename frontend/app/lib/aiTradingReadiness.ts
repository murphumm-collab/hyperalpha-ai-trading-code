...
const STRATEGY_ACTION_API_DETAIL_LABELS: Record<string, string> = {
  ...
  'LLM not configured for AI Trading model adjustment': 'Codex GPT-5.5 profile is not configured',
  ...
  'AI Trading model adjustment requires a Codex GPT-5.5 profile': 'Codex GPT-5.5 profile is required',
  agent_session_archived: 'Agent session is archived',
