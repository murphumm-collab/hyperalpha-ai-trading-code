...
const STRATEGY_ACTION_API_DETAIL_LABELS: Record<string, string> = {
  ...
  'LLM not configured for AI Trading model adjustment': 'GPT/DeepSeek/Qwen profile is not configured',
  ...
  'AI Trading model adjustment requires an OpenAI/GPT, DeepSeek, or Qwen profile': 'GPT/DeepSeek/Qwen profile is required',
  agent_session_archived: 'Agent session is archived',
