...
run_step "Backend compile check" \
  bash -lc "cd backend && uv run python -m py_compile api/ai_stream_routes.py api/ai_trading_routes.py api/kline_routes.py api/account_routes.py api/hyperliquid_routes.py services/hyper_ai_service.py services/hyper_ai_tools.py services/hyper_ai_memory_service.py services/ai_context_compression_service.py services/ai_trading_strategy_spec_service.py services/ai_trading_production_handoff_service.py services/ai_trading_production_readiness_service.py services/llm_transport_security.py services/kline_collectors.py database/migrations/add_ai_trading_agent_session_fields.py scripts/ai_trading_v1_live_stack_acceptance.py scripts/ai_trading_v1_acceptance_smoke.py scripts/ai_trading_model_adjust_live_acceptance.py scripts/ai_trading_v1_env_check.py scripts/ai_trading_production_handoff_check.py scripts/ai_trading_v1_production_readiness_check.py scripts/ai_trading_v1_production_operator_preflight.py scripts/ai_trading_v1_completion_audit.py tests/test_ai_stream_routes.py tests/test_hyper_ai_service_error_safety.py tests/test_hyper_ai_tool_error_safety.py tests/test_hyper_ai_memory_error_safety.py tests/test_hyper_ai_profile_safety.py tests/test_hyper_ai_suggestions_context_safety.py tests/test_hyper_ai_llm_base_url_safety.py tests/test_shared_ai_llm_redirect_guard.py tests/test_account_llm_connection_error_safety.py tests/test_account_hyperliquid_builder_error_safety.py tests/test_hyperliquid_wallet_error_safety.py tests/test_hyperliquid_agent_wallet_error_safety.py tests/test_ai_context_compression_error_safety.py tests/test_ai_trading_env_check.py tests/test_ai_trading_frontend_readiness_source.py tests/test_ai_trading_live_stack_acceptance.py tests/test_ai_trading_model_adjust_live_acceptance.py tests/test_ai_trading_production_readiness_check.py tests/test_ai_trading_production_operator_preflight.py tests/test_ai_trading_production_readiness_api.py tests/test_ai_trading_routes.py tests/test_ai_trading_v1_completion_audit.py tests/test_kline_routes.py tests/test_kline_collectors.py"

run_step "AI Trading backend regression" \
  bash -lc "cd backend && uv run pytest tests/test_ai_stream_routes.py tests/test_hyper_ai_service_error_safety.py tests/test_hyper_ai_tool_error_safety.py tests/test_hyper_ai_memory_error_safety.py tests/test_hyper_ai_profile_safety.py tests/test_hyper_ai_suggestions_context_safety.py tests/test_hyper_ai_llm_base_url_safety.py tests/test_shared_ai_llm_redirect_guard.py tests/test_account_llm_connection_error_safety.py tests/test_account_hyperliquid_builder_error_safety.py tests/test_hyperliquid_wallet_error_safety.py tests/test_hyperliquid_agent_wallet_error_safety.py tests/test_ai_context_compression_error_safety.py tests/test_ai_trading_v1_completion_audit.py tests/test_ai_trading_env_check.py tests/test_ai_trading_frontend_readiness_source.py tests/test_ai_trading_live_stack_acceptance.py tests/test_ai_trading_model_adjust_live_acceptance.py tests/test_ai_trading_production_readiness_check.py tests/test_ai_trading_production_operator_preflight.py tests/test_ai_trading_production_readiness_api.py tests/test_ai_trading_routes.py tests/test_ai_trading_mock_gateway.py tests/test_ai_trading_production_handoff_check.py tests/test_kline_routes.py tests/test_kline_collectors.py -q"
