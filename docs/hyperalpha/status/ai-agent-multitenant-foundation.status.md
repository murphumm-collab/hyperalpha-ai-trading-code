...
- Local Postgres acceptance can resume after Docker Desktop/daemon is running, then `docker compose up -d postgres` can provide `alpha_arena` and `alpha_snapshots`.
