...
PRODUCTION_EVIDENCE_ITEM_GUIDANCE: dict[str, tuple[str, ...]] = {
    ...
    "real_model_profile_live_acceptance": (
        "Configure a user's Hyper AI profile with Codex GPT-5.5 credentials outside the evidence file.",
...
EXTERNAL_REQUIREMENTS: tuple[EvidenceRequirement, ...] = (
    ...
    EvidenceRequirement(
        ...
        track="external_acceptance",
        description="Real Codex GPT-5.5 model-adjust must be accepted with a user Hyper AI profile/API key.",
        path="docs/hyperalpha/ai-trading-v1-acceptance-checklist.zh-CN.md",
        required_phrases=("真实 Codex GPT-5.5 API key live model-adjust 未验收",),
        status_if_present="pending_external_acceptance",
    ),
    EvidenceRequirement(
    ...
    *,
    ...
    return {
        ...
        "next_actions": [
            ...
            "For real model-adjust acceptance, configure a user's Hyper AI Codex GPT-5.5 profile and run the live model-adjust runner with explicit confirmation.",
